...
public class MarvelParser {
   ...
   * @throw IllegalArgumentException if characters or books is null
   */
  public static void parseData(String filename, Set<String> characters,
	...
	if(characters == null || books == null) {
		throw new IllegalArgumentException("one of three parameters is null");
	}
